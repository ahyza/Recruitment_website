		...
		<div class="body-content">
			<form method="post" class="form-x" action="<%=path %>/user/update">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="${user.userName}" name="userName" data-validate="required:不能为空" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
					...
					<div class="field">
						<input type="text" class="input w50" value="${user.userPass}"
				...
				<div class="form-group">
					...
					<div class="field">
						<select name="userRole" class="input w50">
							<option value="1" <c:if test="${user.userRole == 1}">selected</c:if>>求职者</option>
							<option value="2" <c:if test="${user.userRole == 2}">selected</c:if>>招聘者</option>
							<option value="3" <c:if test="${user.userRole == 3}">selected</c:if>>管理员</option>
						</select>
					</div>
				</div>
				<div class="form-group">
